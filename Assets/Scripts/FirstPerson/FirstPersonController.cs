...
public class FirstPersonController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            PlayerGui playerInv = GameObject.FindGameObjectWithTag("Player").GetComponent<PlayerGui>();
            if (playerInv.inventory != null)
                inventory = playerInv.inventory;
            if (playerInv.craftSystem != null)
                craftSystem = playerInv.craftSystem;
            if (playerInv.equipmentSystem != null)
                characterSystem = playerInv.equipmentSystem;
        }
    }
